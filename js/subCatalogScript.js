/*SUBMENU*/
const goodies = document.querySelector(".items-good");
const subGoodies = document.querySelector(".mainsubcatalog__submenu");
const goodiesArrow = document.querySelector(".sub-arrow");

goodies.addEventListener("click", function () {
    subGoodies.classList.toggle("active-submenu");
    goodiesArrow.classList.toggle("active-subarrow");
});
